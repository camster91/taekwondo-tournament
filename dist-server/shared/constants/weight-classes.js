...
export const DEFAULT_WEIGHT_CLASSES = [
...
export function getWeightClass(weight, age, gender, weightClasses = DEFAULT_WEIGHT_CLASSES) {
    const applicable = weightClasses.find((wc) => (wc.gender === null || wc.gender === gender) &&
        age >= wc.ageMin &&
        age <= wc.ageMax &&
