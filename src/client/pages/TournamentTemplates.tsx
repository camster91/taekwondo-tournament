...
export default function TournamentTemplates() {
  ...
  const deleteMutation = useMutation({
    ...
    onError: (error: Error) => {
      toast.addToast(error.message || 'Failed to delete template', 'error');
    },
  });
  ...
  const restoreMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['tournament-templates'] });
      toast.addToast('Template restored successfully', 'success');
    },
    onError: (error: Error) => {
      toast.addToast(error.message || 'Failed to restore template', 'error');
    },
  });
