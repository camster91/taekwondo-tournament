              ...
              return (
                <tr key={item.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-amber-100 dark:bg-amber-900 text-amber-800 dark:text-amber-200 font-semibold text-sm">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    {item.parentEmail ? (
                      <div className="text-sm text-gray-900 dark:text-gray-200">
                        ...
                        <a href={`mailto:${item.parentEmail}`} className="text-blue-600 dark:text-blue-400 hover:underline">
                          {item.parentEmail}
                        </a>
                      </div>
                    ) : (
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-green-600 dark:text-green-400 hover:text-green-900 dark:hover:text-green-300"
