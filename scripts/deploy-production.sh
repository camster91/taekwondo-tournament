...
assert_required_env_vars "$ENV_FILE" "production" \
  ...
  REGISTRATION_CONSENT_VERSION PRIVACY_NOTICE_URL TOURNAMENT_TERMS_URL \
  MAILGUN_API_KEY STRIPE_SECRET_KEY
