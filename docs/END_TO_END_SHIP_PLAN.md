...
- 🚧 PR #TBD: Division exception paths (#139 complete) — POST /api/divisions/merge endpoint with transactional safety and active bracket detection; DivisionExceptionDialog for move/create/merge with audit reasons; director can resolve division conflicts without dead-end warnings
